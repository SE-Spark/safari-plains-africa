...
Route::get('/package/{id?}/{book?}', \App\Http\Controllers\PackageController::class)->name('package');
Route::get('/destination/{id?}', \App\Http\Controllers\DestinationController::class)->name('destination');
