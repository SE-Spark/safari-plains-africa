        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <h4 class="text-white mb-3">Bonanza</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p>Any Time Any Place Your Style</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-8 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Bonanza Adventures Tours & Travel Ltd</a>, All Right Reserved.
                        Designed By <a class="border-bottom" href="https://phinosoft.co.ke">Phinosoft</a>
                    </div>
