                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <div
                                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 1px; font-weight: 400; line-height: 0; text-align: center; color: #F2F2F2;">
                                                                        {{ $title }}</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center"
                                                                    style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                                    <blockquote
                                                                        style="margin: 0 0 0 0px; border: none; padding: 0px;">
                                                                        <table border="0" cellpadding="0"
                                                                            cellspacing="0" role="presentation"
                                                                            style="text-align: center; border-collapse: collapse; border-spacing: 0px;">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="text-align: center; font-family: &quot;Open Sans&quot;, Helvetica, Tahoma, Arial, sans-serif; width: 160px;"
                                                                                        width="160"> <a
                                                                                            href="#"
                                                                                            target="_blank"></a>
                                                                                        <blockquote
                                                                ...
                                                                <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; background-color: #ffffff; border-radius: 10px; vertical-align: top; padding: 30px 25px;"
                                                                    ...
                                                                    <table border="0" cellpadding="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="left"
                                                                                    style="font-family: &quot;Open Sans&quot;, Helvetica, Tahoma, Arial, sans-serif; padding: 0px; word-break: break-word;">
                                                                                    <div
                                                                                        style="font-family: &quot;Open Sans&quot;, Helvetica, Tahoma, Arial, sans-serif; font-weight: bold; line-height: 30px; text-align: left; color: rgb(79, 79, 79);">
                                                                                        <font size="4">
                                                                                            {!! $header !!}
                                                                                        </font>
                                                                                    </div>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" class="link-wrap"
                                                                                    ...
                                                                                    <div
                                                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;">
                                                                                        <i>Everything about tour and travel made easy</i></div>
                                                                                    <div
                                                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;">
                                                                                        <br></div>
                                                                                </td>
                                                                                ...
                                                                                <td align="left" class="link-wrap"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        please, <a target="_blank"
                                                                                            style="font-weight: bold;color: #2E9CC3;"
                                                                                            href="mailto:reservations@safariplains.co.ke">Contact
                                                                                            Us</a>! <br></div>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
...
<![endif]--> <!-- footer start --> <!-- Footer Wrapper -->
        <div class="footer-wrapper" style="margin: 0px auto; max-width: 600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                style="background-color: #FFFFFF; width: 100%;" width="100%" bgcolor="#FFFFFF">
                <tbody>
                    <tr>
         ...
         <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
            <![endif]-->
                            <div class="footer-information" style="margin:0px auto;max-width:600px;">
                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                    role="presentation" style="background-color: #FFFFFF; width: 100%;"
                                    ...
                                    <![endif]-->
                                                <div class="column-per-100 outlook-group-fix"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        width="100%" valign="top" bgcolor="#FFFFFF">
                                                        <tbody>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            |
                                                                            <a href="{{url('/packages')}}"
                                                                                style="color: #333333; line-height: 20px; text-decoration: underline;">Tour Packages</a> 
                                                                        </div>
                                                                        <br> © @php
                                                                            echo date('Y');
                                                                        @endphp Safari Plain Africa<br>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
