<div class="col-lg-4 col-md-6 mb-4 equal-height">
    <div class="package-item bg-white mb-2" style="height:100%;">
        ...
        <div class="p-4">
            ...
            <a class="h5 text-decoration-none" href="{{ route('packages', ['id' => $pack->id]) }}" wire:navigate>
                {!! $pack->summary !!}
            </a>

            <div class="border-top mt-4 pt-4">
                <div class="d-flex justify-content-between">
                    <a href="{{ route('packages', ['id' => $pack->id]) }}" class="btn btn-primary border-radius" wire:navigate>
                        <i>Enquire now</i>
                    </a>
                </div>
            </div>
